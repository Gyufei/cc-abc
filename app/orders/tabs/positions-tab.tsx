        ...
        <Table>
          <Table.Header>
            <Table.Row>
              ...
              <Table.HeaderCell className="whitespace-nowrap">Qty</Table.HeaderCell>
              <Table.HeaderCell className="whitespace-nowrap">Value</Table.HeaderCell>
              <Table.HeaderCell className="whitespace-nowrap">Entry</Table.HeaderCell>
              <Table.HeaderCell className="whitespace-nowrap">Mark Price</Table.HeaderCell>
              <Table.HeaderCell className="whitespace-nowrap">Liq. Price</Table.HeaderCell>
              <Table.HeaderCell className="whitespace-nowrap">IM</Table.HeaderCell>
              <Table.HeaderCell className="whitespace-nowrap">MM</Table.HeaderCell>
          ...
          <Table.Body>
            {positionsData.map((item: PositionData) => (
              <Table.Row key={item.id}>
                ...
                <Table.Cell className="whitespace-nowrap">{item.qty}</Table.Cell>
                <Table.Cell className="whitespace-nowrap">{item.value}</Table.Cell>
                <Table.Cell className="whitespace-nowrap">{item.entry}</Table.Cell>
                <Table.Cell className="whitespace-nowrap">{item.markPrice}</Table.Cell>
                <Table.Cell className="whitespace-nowrap">
                  <span className="text-orange-500">{item.liqPrice}</span>
                </Table.Cell>
                <Table.Cell className="whitespace-nowrap">{item.im}</Table.Cell>
                <Table.Cell className="whitespace-nowrap">{item.mm}</Table.Cell>
